...
export default function Testimonials() {
  ...
  return (
    <section className="py-24 bg-white overflow-hidden relative border-y border-[#053E43]/5">
      ...
      <div className="absolute inset-0 opacity-[0.4] pointer-events-none" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23053E43\' fill-opacity=\'0.05\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
      ...
      <div className="text-center mb-16 relative z-10 px-4">
        ...
        <RevealOnScroll effect="fade-up" delay={0.2}>
          <h2 className="font-['Oswald'] text-4xl sm:text-5xl lg:text-6xl font-bold uppercase tracking-tighter text-[#053E43] leading-[0.9]">
            Trusted by <span className="italic font-bold text-[#0E5F66]">Enthusiasts</span>
          </h2>
        </RevealOnScroll>
